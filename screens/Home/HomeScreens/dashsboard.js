...
const Dashboard = ({ navigation, route }) => {
    ...
    const getSummaryFilterData = async () => {
        ...
        await axios.get(
            `https://beta.centaurmd.com/api/dashboard/reports-summary?datefrom&dateto&filter=Inquiries&${removeComma}`,
            {
                headers: {
                    'Accept': 'application/json',
                    'Authorization': 'Bearer ' + tokenget
            ...
            await axios.get(
                `https://beta.centaurmd.com/api/dashboard/reports-summary?datefrom&dateto&filter=Consults&${removeComma}`,
                {
                    headers: {
                        'Accept': 'application/json',
                        'Authorization': 'Bearer ' + tokenget
            ...
            await axios.get(
                `https://beta.centaurmd.com/api/dashboard/reports-summary?datefrom&dateto&filter=Procedures&${removeComma}`,
                {
                    headers: {
                        'Accept': 'application/json',
                        'Authorization': 'Bearer ' + tokenget
