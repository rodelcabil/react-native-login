    ...
    return(
        <View style={styles.container}>
             ...
             <SafeAreaView style={styles.safeAreaViewContainer}>
                <View 
                 style={{
                    backgroundColor: route.params.item.category === 'consults' ? '#da7331' : route.params.item.category === 'procedures' ? '#ffc000' :  route.params.item.category === 'reminder' ? '#3a87ad' :  '#81c784',
                    borderRadius: 10,
                    ...
                    <View style={styles.rowContainer}>
                        ...
                        <Text style={styles.scheduleStyle}>{route.params.item?.start}</Text>
                    </View>
                    </View> 
                </View>
             </SafeAreaView>
